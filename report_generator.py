...
# report_generator.py - Vulnerability Reporting and Compliance Mapping for Web App Security Tool

import json

# Define scoring criteria for vulnerabilities and compliance mappings
SEVERITY_SCORES = {
    "critical": 10,
    "high": 7,
    "medium": 5,
...
COMPLIANCE_MAPPING = {
    ...
    "csrf": "OWASP A8: Cross-Site Request Forgery (CSRF)",
    "auth_bypass": "OWASP A2: Broken Authentication",
    "csp_missing": "OWASP A6: Security Misconfiguration"
}
